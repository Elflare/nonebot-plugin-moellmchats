...
- 多模态视觉支持：
    - 支持发送图片给具备视觉能力的模型（如 GPT-4o, Claude-3.5-Sonnet）
    - 智能兼容设计：仅当前对话启用多模态，历史记录自动回退为纯文本，大幅节省 Token 并保持上下文整洁
...
## 更新日志
### 2025-11-24 v0.16
- 新增：多模态视觉支持。现在可以在配置中为支持视觉的模型添加 "is_vision": true，即可识别用户发送的图片或引用的图片。
