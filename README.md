...
- [nonebot-plugin-moellmchats](#nonebot-plugin-moellmchats)
  ...
  - [⚙️ 配置](#️-配置)
    ...
    - [本插件主要配置](#本插件主要配置)
      ...
      - [系统动态缓存 model\_cache.json(系统维护)](#系统动态缓存-model_cachejson系统维护)
      ...
      - [原生自定义函数目录 custom\_tools/(手动维护)](#原生自定义函数目录-custom_tools手动维护)
  ...
  - [🔄 处理流程](#-处理流程)
  - [更新日志](#更新日志)
    - [2026-04-07 v0.19.0](#2026-04-07-v0190)
    - [2026-04-06 v0.18.6, v0.18.7](#2026-04-06-v0186-v0187)
    - [2026-04-06 v0.18.3, v0.18.4, v0.18.5](#2026-04-06-v0183-v0184-v0185)
    - [2026-04-04 v0.18.0, v0.18.1, v0.18.2](#2026-04-04-v0180-v0181-v0182)
    - [2025-11-24 v0.16 v0.17 v0.17.1 v0.17.2](#2025-11-24-v016-v017-v0171-v0172)
    - [2025-06-22 v0.15.11](#2025-06-22-v01511)
    - [2025-05-20 v0.15.10](#2025-05-20-v01510)
    - [2025-05-13 v0.15.9](#2025-05-13-v0159)
    - [2025-04-23 v0.15.8](#2025-04-23-v0158)
    - [2025-04-22 v0.15.7](#2025-04-22-v0157)
    - [2025-04-21 v0.15.6](#2025-04-21-v0156)
    - [2025-04-16 v0.15.5](#2025-04-16-v0155)
    - [2025-04-16 v0.15.4](#2025-04-16-v0154)
    - [2025-04-13 v0.15.2](#2025-04-13-v0152)
    - [2025-04-12 v0.15.0](#2025-04-12-v0150)
  - [鸣谢](#鸣谢)
...
|     查看可用模型     | 超级管理员 | 私聊 / 群聊 |    [供应商名]     |                     列出所有可用模型                      |
|     查看当前配置     | 超级管理员 | 私聊 / 群聊 |        无         |       可视化展示当前大模型各项运行状态与绑定的模型        |
...
|      查看黑名单      | 超级管理员 | 私聊 / 群聊 |        无         |  查看当前禁止大模型调用的插件列表，`查看插件黑名单` 均可  |
